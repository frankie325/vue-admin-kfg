<template>
    <el-card class="tree-container">
        ...
        <div class="content">
            <div class="m-b-15">
                <el-input :validate-event="false" v-model="searchText" placeholder="请输入搜索内容" size="normal" clearable>
            ...
            <div class="tree-warp scrollbar-hide">
                ...
                >
                    <div class="node-warp flex row-between" slot-scope="{ node, data }">
                        <div class="m-r-6 p-t-3">
                            <i v-if="data.depOrRole === 1" class="el-icon-s-home"></i>
                        ...
                        <div class="oprate-btn m-l-6" v-show="showOprateBtn">
                            <el-popover placement="bottom" trigger="click" v-if="data.depOrRole === 1">
                                <el-button
                                    @click.stop
                                    class="m-r-10"
                                    slot="reference"
                                ...
                                ></el-button>
                                <div>
                                    <el-button size="mini" @click.stop="addNode(2, node, data)">添加部门</el-button>
                                    <el-button size="mini" @click.stop="addNode(3, node, data)">添加角色</el-button>
                                </div>
                            </el-popover>
                            <el-button
...
export default {
    ...
    methods: {
        ...
        allowDrop(draggingNode, dropNode, type) {
            ...
            if (dropNode.data.depOrRole === 2 && type === "inner") {
                return false;
            } else {
                return true;
            }
